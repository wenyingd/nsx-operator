...
func (s *DNSRecordService) tagsForOwner(owner *ResourceRef) []model.Tag {
	basicTags := append(util.BuildClusterTags(getCluster(s)),
...
func (r *EndpointRow) appendRowOwnershipTags(basicTags []model.Tag) []model.Tag {
	gwKey := ""
	...
	return appendRecordOwnershipTags(tags, gwKey, r.contributingOwnerKeys)
}
