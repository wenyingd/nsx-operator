...
var (
	NSMsgVPCNetCfgNotFound       = newNsUnReadyMessage("Error happened to get VPC network configuration: %v", NSReasonVPCNetConfigNotReady)
...
func (r *NetworkInfoReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		setNSNetworkReadyCondition(ctx, r.Client, req.Namespace, NSMsgVPCNetCfgNotFound, err)
