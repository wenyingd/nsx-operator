...
func setNSNetworkReadyCondition(ctx context.Context, client client.Client, nsName string, message *nsUnReadyMessage, msgOptions ...interface{}) {
	obj := &v1.Namespace{}
	...
	condition := message.getNSNetworkCondition(msgOptions...)
