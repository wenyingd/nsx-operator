...
func (r *GatewayReconciler) buildRouteDNSEndpointsForAggregation(routeNS string, owner *dns.ResourceRef, parentRefs []gatewayv1.ParentReference,
	parentStatus []gatewayv1.RouteParentStatus, objMeta *metav1.ObjectMeta,
	...
	return r.DNS.ValidateEndpointsByZone(objMeta.GetNamespace(), owner, eps)
}
...
func (a routeReconcilerAdapter[PT, T]) reconcileRouteDNS(ctx context.Context, req ctrl.Request, wrapper PT) (ctrl.Result, error) {
	...
	if err := a.reconciler.Client.Get(ctx, req.NamespacedName, route); err != nil {
		if apierrors.IsNotFound(err) { // Route gone: drop DNS owner rows
			if _, derr := a.reconciler.DNS.DeleteRecordByOwnerNN(ctx, a.kind, req.Namespace, req.Name); derr != nil {
	...
	cacheChanged, opErr := a.reconciler.DNS.CreateOrUpdateRecords(ctx, batch)
	if opErr != nil {
...
func (r *GatewayReconciler) registerRouteDNSControllers(mgr ctrl.Manager) error {
	...
	if r.apiResources.httpRoute {
		...
		if err := registerRouteReconciler[*HTTPRoute, gatewayv1.HTTPRoute, *gatewayv1.HTTPRoute](
			r, dns.ResourceKindHTTPRoute, func() *HTTPRoute { return &HTTPRoute{} }, httpRouteMgrBuilder, opts,
	...
	if r.apiResources.grpcRoute {
		...
		if err := registerRouteReconciler[*GRPCRoute, gatewayv1.GRPCRoute, *gatewayv1.GRPCRoute](
			r, dns.ResourceKindGRPCRoute, func() *GRPCRoute { return &GRPCRoute{} }, grpcRouteMgrBuilder, opts,
	...
	if r.apiResources.tlsRoute {
		...
		if err := registerRouteReconciler[*TLSRoute, gatewayv1.TLSRoute, *gatewayv1.TLSRoute](
			r, dns.ResourceKindTLSRoute, func() *TLSRoute { return &TLSRoute{} }, tlsRouteMgrBuilder, opts,
			func() client.ObjectList { return &gatewayv1.TLSRouteList{} },
		); err != nil {
			return err
		}
	}
...
func newRouteReconciler[PT RouteObject[T], T any](r *GatewayReconciler, kind string, wrapperFn func() PT) *routeReconcilerAdapter[PT, T] {
	return &routeReconcilerAdapter[PT, T]{reconciler: r, kind: kind, wrapper: wrapperFn}
}

// registerRouteReconciler registers one Route DNS controller. PI Object[T] is the Gateway API pointer type (*gatewayv1.HTTPRoute, etc.).
func registerRouteReconciler[PT RouteObject[T], T any, PI Object[T]](
	r *GatewayReconciler,
	kind string,
	wrapperFn func() PT,
	mgrBuilder *builder.TypedBuilder[reconcile.Request],
	...
	b = b.Watches(
		...
		handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, obj client.Object) []reconcile.Request {
			return networkInfoToRouteDNSRequests[T, PI](ctx, r.Client, obj, kind, newRouteList())
		}),
