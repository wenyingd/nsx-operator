	...
	for _, res := range resourceList.APIResources {
		...
		case "httproutes":
			rr := newRouteReconciler[*HTTPRoute, gatewayv1.HTTPRoute, *gatewayv1.HTTPRoute](
				r, dns.ResourceKindHTTPRoute, func(v *gatewayv1.HTTPRoute) *HTTPRoute {
					if v == nil {
						return &HTTPRoute{}
					}
		...
		case "grpcroutes":
			rr := newRouteReconciler[*GRPCRoute, gatewayv1.GRPCRoute, *gatewayv1.GRPCRoute](
				r, dns.ResourceKindGRPCRoute, func(v *gatewayv1.GRPCRoute) *GRPCRoute {
					if v == nil {
						return &GRPCRoute{}
					}
		...
		case "tlsroutes":
			rr := newRouteReconciler[*TLSRoute, gatewayv1.TLSRoute, *gatewayv1.TLSRoute](
				r, dns.ResourceKindTLSRoute, func(v *gatewayv1.TLSRoute) *TLSRoute {
					if v == nil {
						return &TLSRoute{}
					}
